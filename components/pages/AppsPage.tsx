...
const apps: AppEntry[] = [
  ...
  {
    name: 'Prophetic Table',
    tagline: 'Foods of the Sunnah — with their evidence.',
    description:
      'A source-grounded reference on foods, dishes and eating practices connected to the Prophet Muhammad ﷺ. Every piece of Islamic text is quoted verbatim from the authenticated corpus — Sahih al-Bukhari, Sahih Muslim and the Qur\'an — and kept strictly separate from the culinary reconstruction and nutritional notes that sit beneath it.',
    href: 'https://prophetictable.sayyidinaomarinstitute.au',
    icon: <Utensils className="w-7 h-7" />,
    badge: 'Installable App',
    installable: true,
    features: [
      'Foods and eating practices tied to the Prophet ﷺ',
      'Verbatim hadith and Quran citations with source',
      'Evidence separated from reconstruction & nutrition',
      'Works offline once installed',
    ],
  },
  {
